    ...
    <form class="row">
      <div id="btn-back">
        ...
        <div class="col-6" id="form-auth-user">
            <h2 id="auth-title">Dependence Update</h2><br>
            <div class="row">
              <div class="col-12">
              ...
              <div id="div-btn-auth-save" class="col-12">
                  <button id="btn-auth-save" class="btn" @click="updateDep">Save</button>
              </div>
            </div>          
        </div>
    </form>       
...
export default {
  ...
  methods: {
    async updateDep() {
      ...
      await axios.put(`http://localhost:8888/apitickets/dependence/update/${id}`, depData, {
        headers: {
